...
export default function Header() {
  ...
  return(
    <header className='flex justify-between bg-black-400'>
      {/*logo*/}
      ...
      {/*search*/}
      <div className='gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300 hidden sm:flex'>
        <div>Anywhere</div>
      ...
      {/*user*/}
      <Link to={user?'account':'/login'} className='flex items-center gap-1 border border-gray-300 rounded-full py-1 px-2'>
